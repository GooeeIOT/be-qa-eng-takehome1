...
If you want to get fancier, have it it; ideally you'd want to report how the test failed rather than a boolean pass/fail to cut down on mean-time-to-diagnose.
